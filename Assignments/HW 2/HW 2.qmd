...
#this plot is another version of the above but uses ggplotly
...
:::{.callout-note}
I have both versions in here because using `plot_ly` I can't change the legend title, and `ggplotly` doesn't allow me to change the legend position.
:::